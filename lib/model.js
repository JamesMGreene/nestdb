 ...
 */
export function deepCopy (obj, strictKeys) {
  var res
 ...
 */
export function compareThings (a, b, _compareStrings) {
  var aKeys; var bKeys; var comp; var i
...
lastStepModifierFunctions.$push = function (obj, field, value) {
  ...
  if (value !== null && typeof value === 'object' && value.$each) {
    ...
    if (value.$slice === 0) {
      ...
      var start; var end; var n = obj[field].length
      if (value.$slice < 0) {
...
export function modify (obj, updateQuery) {
  ...
  var firstChars = _.map(keys, function (item) { return item[0] })

  var dollarFirstChars = _.filter(firstChars, function (c) { return c === '$' })

  var newDoc; var modifiers
...
function matchQueryPart (obj, queryKey, queryValue, treatObjAsValue) {
  ...
  var i; var keys; var firstChars; var dollarFirstChars
