 ...
 * @public
 */
export function append (file, data, callback) {
 ...
 * @public
 */
export function remove (file, callback) {
 ...
 */
export function write (filename, data, cb) {
 ...
 */
export function init (filename, callback) {
  var tempFilename = filename + '~'

  fs.stat(filename, function (err) {
    const filenameExists = (err === null)

    // Write was successful
    if (filenameExists) { return callback(null) }

    fs.stat(tempFilename, function (err) {
      const oldFilenameExists = (err === null)
