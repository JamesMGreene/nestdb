...
Datastore.prototype.load = function (cb) {
  ...
  var callback = cb || function (err) { if (err) { throw err } }
...
Datastore.prototype.addToIndexes = function (doc) {
  var i; var failingIndex; var error
...
Datastore.prototype.getCandidates = function (query, dontExpireStaleDocs, callback) {
  ...
  // STEP 1: get candidates list by checking indexes from most to least frequent usecase
    ...
    function (docs) {
      ...
      var expiredDocsIds = []; var validDocs = []; var ttlIndexesFieldNames = Object.keys(self.ttlIndexes)
...
Datastore.prototype._update = function (query, updateQuery, options, cb) {
  ...
  async.waterfall([
    ...
    function () { // Perform the update
      ...
      var eventedCallback = function (err /*, numReplaced, updatedDocs, upserted */) {
        var context = this
