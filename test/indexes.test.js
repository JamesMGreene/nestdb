...
describe('Indexes', function () {
  describe('Insertion', function () {
    it('Can insert pointers to documents in the index correctly when they have the field', function () {
      ...
      var doc1 = { a: 5, tf: 'hello' }

      var doc2 = { a: 8, tf: 'world' }

      var doc3 = { a: 2, tf: 'bloup' }
    ...
    it('Works with dot notation', function () {
      ...
      var doc1 = { a: 5, tf: { nested: 'hello' } }

      var doc2 = { a: 8, tf: { nested: 'world', additional: true } }

      var doc3 = { a: 2, tf: { nested: 'bloup', age: 42 } }
    ...
    describe('Array fields', function () {
      ...
      it('Inserts one entry per unique array element in the index, the unique constraint only holds across documents', function () {
        ...
        var obj2 = { tf: ['cc', 'yy', 'cc'], yes: 'indeed' }
      ...
      it('The unique constraint holds across documents', function () {
        ...
        var obj2 = { tf: ['cc', 'aa', 'cc'], yes: 'indeed' }
      ...
      it('If a unique constraint is violated when inserting an array key, roll back all inserts before the key', function () {
        ...
        var obj2 = { tf: ['cc', 'dd', 'aa', 'ee'], yes: 'indeed' }
  ...
  describe('Removal', function () {
    ...
    it('Works with dot notation', function () {
      ...
      var doc4 = { a: 2, tf: { nested: 'world', fruits: ['apple', 'carrot'] } }
  ...
  describe('Update', function () {
    ...
    it('Can update an array of documents', function () {
      ...
      var doc1b = { a: 23, tf: 'world' }

      var doc2b = { a: 1, tf: 'changed' }

      var doc3b = { a: 44, tf: 'bloup' }
    ...
    it('If a unique constraint is violated during an array-update, all changes are rolled back and an error thrown', function () {
      ...
      var doc1b = { a: 23, tf: 'changed' }

      var doc2b = { a: 1, tf: 'changed' } // Will violate the constraint (first try)
      var doc3b = { a: 44, tf: 'alsochanged' }
    ...
    it('Can revert simple and batch updates', function () {
      ...
      var batchUpdate = [{ oldDoc: doc1, newDoc: doc1b }, { oldDoc: doc2, newDoc: doc2b }, { oldDoc: doc3, newDoc: doc3b }]
  ...
  describe('Get matching documents', function () {
    ...
    it('Can get all documents for which a field is undefined', function () {
      ...
      var doc2 = { a: 2, nottf: 'bloup' }

      var doc3 = { a: 8, tf: 'world' }

      var doc4 = { a: 7, nottf: 'yes' }
    ...
    it('Can get all documents for which a field is null', function () {
      ...
      var doc2 = { a: 2, tf: null }

      var doc3 = { a: 8, tf: 'world' }

      var doc4 = { a: 7, tf: null }
    ...
    it('Can get all documents whose key is in an array of keys', function () {
      ...
      // or a fingerprinting algorithm, both solutions too complicated and slow given that live
      // NestDB indexes documents with _id always set
      var idx = new Index({ fieldName: 'tf' })

      var doc1 = { a: 5, tf: 'hello', _id: '1' }

      var doc2 = { a: 2, tf: 'bloup', _id: '2' }

      var doc3 = { a: 8, tf: 'world', _id: '3' }

      var doc4 = { a: 7, tf: 'yes', _id: '4' }

      var doc5 = { a: 7, tf: 'yes', _id: '5' }
    ...
    it('Can get all documents whose key is between certain bounds', function () {
      ...
      var doc2 = { a: 2, tf: 'bloup' }

      var doc3 = { a: 8, tf: 'world' }

      var doc4 = { a: 7, tf: 'yes' }

      var doc5 = { a: 10, tf: 'yes' }
  ...
  describe('Resetting', function () {
    ...
    it('Can reset an index and initialize it with an array of documents', function () {
      ...
      var newDocs = [{ a: 555, tf: 'new' }, { a: 666, tf: 'again' }]
